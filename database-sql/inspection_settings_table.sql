...
-- Create policy to allow dealerships to manage their own inspection settings
...
-- CREATE POLICY "Users can manage their dealership's inspection settings"
--     ON inspection_settings
--     FOR ALL
--     USING (auth.uid() IN (
--         SELECT user_id FROM dealership_users WHERE dealership_id = inspection_settings.dealership_id
--     ))
