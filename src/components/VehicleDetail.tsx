                ...
                <div className="mt-4 pt-4 border-t border-gray-200/60 dark:border-gray-700/60">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      />
                      {editErrors.dateAcquired && <p className="text-red-600 dark:text-red-400 text-xs mt-1">{editErrors.dateAcquired}</p>}
                    </div>
                  ...
                  <div className="mt-4">
                    ...
                    <textarea
                      ...
                      onChange={(e) => handleEditInputChange('notes', e.target.value)}
                      rows={3}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white resize-none"
